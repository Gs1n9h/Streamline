...
export default function GeofenceManagement({ companyId, geofencingEnabled = true }: GeofenceManagementProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400"
          title={!geofencingEnabled ? "Enable geofencing first to create geofences" : "Create a new geofence"}
        >
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">
                Geofencing is currently disabled
              </h3>
              <p className="mt-2 text-sm text-yellow-700">
                Enable geofencing above to create and manage geofences. Existing geofences will not trigger events while geofencing is disabled.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-400 mt-2">
              {geofencingEnabled 
                ...
                : "Enable geofencing to create geofences"
              }
            </p>
          </div>
        ) : (
