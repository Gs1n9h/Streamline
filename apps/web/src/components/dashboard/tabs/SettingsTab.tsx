...
import { Settings, Building2, Clock, DollarSign, MapPin, Save, Briefcase, Users, ToggleLeft, ToggleRight } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage your company information and job tracking settings</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <LocationSettings companyId={companyId} />
      </div>

      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center mb-6">
          <MapPin className="w-6 h-6 text-green-600 mr-3" />
          <h2 className="text-xl font-semibold text-gray-900">Geofencing</h2>
        </div>
